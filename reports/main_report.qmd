...
![Distribution of Variables](../images/chart2_team_above.png){#fig-var_dist_2_team1 width=90% height=90%}

![Distribution of Variables](../images/chart2_team_below.png){#fig-var_dist_2_team2 width=90% height=90%}
