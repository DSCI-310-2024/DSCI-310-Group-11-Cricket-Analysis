...
The hyperparameter we are looking at in Logistic Regression is $C$. 
...
3. Hyperparameter Optimization: Tuning the regularization parameter (C) of the Logistic Regression model to find the optimal balance between underfitting and overfitting. 
