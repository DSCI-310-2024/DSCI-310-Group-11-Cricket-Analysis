...
![Imagen of A bar chart depicting the distribution of sales data](../images/chart1.png){ #fig-1}

**Caption:** This In @fig-1 bar chart illustrates the distribution of sales data across various product categories. As evident, Category A has the highest sales volume, followed by Category B and Category C.